			...
			<el-row>
				<el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
					<el-form-item label="渠道" prop="channelCode">
						...
						<cascaderItem :options="channeSearchlList" @change="channelChange" :value.sync="channelName" v-if="!isChannel"></cascaderItem>
			...
			<el-row>
				...
				<el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
					<el-form-item :label="dataDic.reputationList[0].value + '级分上限:'" prop="AMaxScore">
						<inputItem :value.sync="form.AMaxScore"></inputItem>
					</el-form-item>
				</el-col>
			</el-row>
			<el-row>
			...
			<el-row>
				<el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
					<el-form-item :label="dataDic.reputationList[4].value + '级分下限:'" prop="EMinScore">
						<inputItem :value.sync="form.EMinScore"></inputItem>
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
