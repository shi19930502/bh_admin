	...
	export default {
		...
		methods: {
			...
			exportExcel() {
				...
				window.location.href = configs.excelUrl + '?distributionTimeBegin=' + vm.distributionTimeBegin + '&extendIndex=' + vm.searchForm.extendIndex + '&channelCode=' + vm.searchForm.channelCode
			},
