					...
					.then((function(d) {
						if(d.aaData.length > 0) {
							...
							data.forEach((function(el, index) {
								...
								let checkResult = el.checkResult || ''
								let checkDate = el.checkDate || ''
								let checkDescription = checkDescription || ''
								let remark = el.remark || ''
								let html = `
								<tr>
									<td style="text-align: center; border: solid 1px black;word-break:break-word;">${index}</td>
							        ...
							        <td style="text-align: center; border: solid 1px black;word-break:break-word;">${checkDescription}</td>
							...
							<table style="text-align: center; border-collapse: collapse; width: 100%">
						        <thead style="font-size:18px;">
						            <tr>
						                ...
						                <th style="text-align: center; border: solid 1px black;word-break:break-word;">检测结果描述</th>
