<template>
	<el-dialog custom-class="jz-modal" :close-on-click-modal="false"  :modal="false" width="1270px" title="订单详情" :visible="modal" :before-close='beforeClose'>
        ...
        exportExcel() {
            ...
            this._ajax({
                ...
                table.forEach(function (row) {
                    ...
                    row.sortingWeight = row.sortingWeight + ' ' + row.skuMeasureName;
                    row.sortingTotal = this._priceFormat(row.sortingTotal) + ' 元';
                }.bind(this));
                let header = [{
                    productName: "预计配送时间:",
                    skuName: this.form.distributionTimeBegin,
                    oriPrice: "",
                    price: "订单金额:",
                    quantity: this.form.orderTotal + '元',
                    itemTotal: "",
                    sortingWeight: "分拣金额:",
                    sortingTotal: this.form.sortingOrderTotal + '元',
                    batchId: "",
                    suyuanCode: "验收金额:",
                    comment: this.form.inspectedOrderTotal + '元',
                },{
                    productName: "",
                    skuName: "",
                    oriPrice: "",
