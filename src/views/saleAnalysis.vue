    ...
    <div class="sale_analysis">
        ...
        <div class="header_four">
            <div class="header_four_item">
                <div>销售额</div>
                <p>{{this.orderPriceTotal }}&nbsp;<span>元</span></p>
            </div>
            <div class="header_four_item">
                <div>毛利</div>
        ...
        <elemTable :dataList="dataList" :currentPage='pageNum' :pageSize="pageSize" :pageTotal="pageTotal" :loading="dataLoading" @sizeChange="handleSizeChange" @currentChange="handleCurrentChange" @selectionChange="selectionChange">
            ...
            <el-table-column prop="sortTotal" label="销售额">
                <template slot-scope="scope">
            ...
            <el-table-column prop="groseProfit" label="毛利">
                <template slot-scope="scope">
            ...
            <el-table-column prop="ratio" label="利率">
                <template slot-scope="scope">
            ...
            searchTable() {
                ...
                this._ajax({
                  ...
                  function(d) {
                    ...
                    var priceTotal=0;
                    d.aaData.forEach(function(d){
                      priceTotal+=d.sortTotal==null?0:d.sortTotal;
                    })
                    this.orderPriceTotal=priceTotal;
                  }.bind(this)
                );
                this.getThreeData();
            },
