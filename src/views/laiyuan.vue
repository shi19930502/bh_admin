		...
		<elemTable :dataList="dataList" :currentPage='pageNum' :pageSize="pageSize" :pageTotal="pageTotal" :loading="dataLoading" @sizeChange="handleSizeChange" @currentChange="handleCurrentChange" @selectionChange="selectionChange">
			<el-table-column prop="areaName" label="来源地">
		    	<template slot-scope="scope">
		    		<toolTip :content="scope.row.areaName">
		    ...
		    <el-table-column prop="priceTotal" label="总金额">
		    	<template slot-scope="scope">
		    		<toolTip :content="scope.row.priceTotal">
	...
	export default {
		...
		methods: {
			...
			setWeightPie(legenddata, seriesdata) {
				weightPie.setOption(this._setPie({legend: legenddata, seriesData: seriesdata, title: '按重量统计'}));
			},
			setPricePie(legenddata, seriesdata) {
				pricePie.setOption(this._setPie({legend: legenddata, seriesData: seriesdata, title: '按金额统计'}));
			},
			exportExcel() {
